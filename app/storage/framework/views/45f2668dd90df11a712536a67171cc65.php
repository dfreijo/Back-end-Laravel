...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/crear_acto.css')); ?>">
</head>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body lista-actos">
                            ...
                            <div class="tipoActo">
                                ...
                                <form method="POST" action="<?php echo e(route('adminTypeEventEdit')); ?>" class="formulario-editar-tipoActo border p-3" style="display:none;">
                        ...
                        <button class="btn btn-primary" id="btnMostrarFormulario">Agregar</button>
                            ...
                            <form class="border p-3" action="<?php echo e(route('adminTypeEventAdd')); ?>" method="post" id="formularioCrearTipoActo" style="display: none;">
                                <div class="form-group">
                                    <label for="Descripcion">Descripcion del tipo de Acto</label>
                            ...
                            <a href="<?php echo e(route('adminBack')); ?>" class="btn btn-primary button-atras">Atras</a>
                    </div>
                </div>
            </div>
        </div>
...
</html><?php /**PATH /var/www/html/resources/views/adminTypeEvent.blade.php ENDPATH**/ ?>