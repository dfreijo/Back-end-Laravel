...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/usuarioVista.css')); ?>">
...
<body>
    <div class="container">
        <div class="jumbotron mt-3 text-center">
            <h1 class="display-4">CALENDARIO DE <?php echo e($Username); ?>

                <a href="<?php echo e(route('userBack')); ?>" class="btn btn-primary button-cerrar">Cerrar sesión</a>
            </h1>
            <p class="lead">Correo electrónico: <?php echo e($Email); ?></p>
            ...
            <form action="<?php echo e(route('userInscription')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="Id" value="<?php echo e($Id); ?>">
                <input type="hidden" name="Username" value="<?php echo e($Username); ?>">
                <input type="hidden" name="Password" value="<?php echo e($Password); ?>">
            ...
            <form action="<?php echo e(route('userDesInscription')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="Id" value="<?php echo e($Id); ?>">
                <input type="hidden" name="Username" value="<?php echo e($Username); ?>">
                <input type="hidden" name="Password" value="<?php echo e($Password); ?>">
            ...
            <div class="text-center mt-3 botones-calendario">
                <button class="btn btn-primary mr-2 calendario" onclick="window.location.href='<?php echo e(route('usuarioVista', ['view' => 'mes', 'Id' => $Id, 'Username' => $Username, 'Password' => $Password, 'Email' => $Email])); ?>'">Mes</button>
                <button class="btn btn-primary mr-2 calendario" onclick="window.location.href='<?php echo e(route('usuarioVista', ['view' => 'semana', 'Id' => $Id, 'Username' => $Username, 'Password' => $Password, 'Email' => $Email])); ?>'">Semana</button>
                <button class="btn btn-primary calendario" onclick="window.location.href='<?php echo e(route('usuarioVista', ['view' => 'dia', 'Id' => $Id, 'Username' => $Username, 'Password' => $Password, 'Email' => $Email])); ?>'">Dia</button>
            </div>
            ...
            <?php
                ...
                if(isset($view)){
                    ...
                    $actosPersonas = Inscrito::where('Id_persona', $Id)->get();
                        ...
                        for ($hour = 8; $hour <= 24; $hour++) {
                            ...
                            if(isset($combinacionActos) && !empty($combinacionActos)){
                                foreach ($combinacionActos as $acto) {
                                    ...
                                    $actoDia = $acto['dia']; // Guardar el valor original
                                    $acto['dia'] = sprintf("%02d", $actoDia);
                            ...
                            if(isset($combinacionInscritos) && !empty($combinacionInscritos)){
                                foreach ($combinacionInscritos as $inscrito) {
                                    ...
                                    $currentHora = date('H', strtotime($currentDateTime));
                                    $inscritoDia = $inscrito['dia']; // Guardar el valor original
                                    $inscrito['dia'] = sprintf("%02d", $inscritoDia);
                                    //echo " -> " . $inscrito['dia'] . " ->" .  date('d', strtotime($currentDateTime)) . "<br>";
...
<?php /**PATH /var/www/html/resources/views/user.blade.php ENDPATH**/ ?>