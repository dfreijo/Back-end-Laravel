            ...
            <div class="col-10">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="border p-3" action="<?php echo e(route('adminAddEventInsert')); ?>" method="post">
                            ...
                            <?php if(isset($mensaje)): ?>
                                <?php if($mensaje === 'Error al crear el evento'): ?>
                        ...
                        <a href="<?php echo e(route('adminBack')); ?>" class="btn btn-primary button-cerrar">Atras</a>
                    </div>
                </div>
            </div>
        </div>
...
</html><?php /**PATH /var/www/html/resources/views/adminAddEvent.blade.php ENDPATH**/ ?>